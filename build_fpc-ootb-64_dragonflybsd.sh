...
$COMPILER -Mfpc -Scgi -CX -Cg -Os1 -Xs -XX -l -vewnhibq -Fipackages/ide -Ficompiler -Ficompiler/x86_64 -Fucompiler -Fucompiler/x86 -Fucompiler/x86_64 -Fucompiler/systems -Fupackages/rtl-extra/src/inc -Fupackages/fv/src -Fupackages/ide/ -FUpackages/ide/ -FEpackages/ide/ -opackages/ide/fp -dx86_64 -dnodebug -B packages/ide/fp.pas 
...
mkdir ./fpc-ootb-64/units/x86_64-dragonfly
...
cp ./packages/ide/fp ./fpc-ootb-64/fpide-ootb-64
#cp /tmp/fpc-ootb/usr/bin/fp ./fpc-ootb-64/fpide-ootb-64
cp /tmp/fpc-ootb/usr/lib/libpas2jslib.so ./fpc-ootb-64/lib/
cp -rf /tmp/fpc-ootb/usr/lib/fpc/3.2.4/units/x86_64-dragonfly ./fpc-ootb-64/units
...
tar -zcvf fpc-ootb-324-x86_64-dragonflybsd.tar.gz ./fpc-ootb-64
#rm -f -r /tmp/fpc-ootb
#rm -f -r ./fpc-ootb-64
