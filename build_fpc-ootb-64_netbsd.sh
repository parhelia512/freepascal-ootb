...
mkdir ./fpc-ootb-64/units/x86_64-netbsd
...
cp -rf /tmp/fpc-ootb/usr/lib/fpc/3.2.4/units/x86_64-netbsd ./fpc-ootb-64/units
...
tar -zcvf fpc-ootb-324-x86_64-netbsd.tar.gz ./fpc-ootb-64
rm -f -r /tmp/fpc-ootb
#rm -f -r ./fpc-ootb-64
